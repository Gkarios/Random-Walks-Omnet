...
experiments = [
    ("rw_1", "1rw"),
    ("duplication_500_Interval", "taxi  - rw cloning (Clone | I = 500 hops)"),
    ("no_backtracking", "no backtracking"),
    ("hybrid_500_Interval", "cloning & no backtracking | I = 500 hops")
]
...
plt.title("Random Walker Network 99% Coverage - Comparing four algorithms", fontsize=14, weight='bold')

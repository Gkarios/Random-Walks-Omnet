...
num_nodes = 145
experiments = [
    ("taxi_normal_rw", "taxi coverage - 1rw"),
    ("taxi-rw-2", "taxi coverage - 2rw"),
    ("taxi-rw-3", "taxi coverage - 3rw"),
    ("taxi-rw-5", "taxi coverage - 5rw")
]
...
plt.title("Random Walker Network Coverage by # of RW", fontsize=14, weight='bold')
